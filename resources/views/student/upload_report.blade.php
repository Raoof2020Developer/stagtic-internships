...
<head>
  ...
  <title>Upload Report- STAGTIC</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('UploadReport')}}" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Upload Repport</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('StudentDashboard')}}">Home</a></li>
            <li class="breadcrumb-item active"><a href="{{route('UploadReport')}}"> Upload Repport</a></li>
          </ol>
        </nav>
      </div><!-- End Page Title -->
