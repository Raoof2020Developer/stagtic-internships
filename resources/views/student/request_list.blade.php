    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{route('StudentRequestList')}}" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="{{route('StudentRequestList')}}">Request List</a> </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Internship Theme</th>
                    <th scope="col"> Name Company</th>
                    <th scope="col">State Request Head</th>
                    <th scope="col">State Request Supervisor</th>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td>{{ $request->internship->internship_theme }}</td>
                      <td>{{ $request->company->name_company }}</td>
                      <td>{{ $request->state_request_head }}</td>
                      <td>{{ $request->state_request_supervisor }}</td>
                      <td><a href="{{route('NoteDetailsStudent')}}"><i  class="bi bi-pencil-square"></i></a></td>
                      <td><a href="{{route('NoteDetailsStudent')}}"><i class="bi bi-trash"></i></a></td>
                  </tr>
              @endforeach
                </tbody>
              </table>
