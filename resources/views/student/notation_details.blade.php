...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <a href="{{route('NoteStudent')}}" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Internship Mark Details</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{route('StudentDashboard')}}">Home</a></li>
          <li class="breadcrumb-item active"> <a href="{{route('NoteStudent')}}">Internship Mark</a></li>
          <li class="breadcrumb-item active"> <a href="{{route('NoteDetailsStudent')}}" >Internship Mark Details</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
