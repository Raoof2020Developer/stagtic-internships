...
<head>
  ...
  <title>Users / Profile - STAGTIC </title>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{route('StudentProfile')}}" <i class="bi bi-person"></i>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{route('StudentProfile')}}" <i class="bi bi-gear"></i>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>My Internship</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('StudentProfile')}}" <i class="bi bi-person "></i>
          <span>Profile</span>
        </a>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="{{route('StudentProfile')}}">Profile </a> </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                <div class="tab-pane fade  show active profile-edit pt-3" id="profile-edit">
                  <!-- Profile Edit Form -->
                  <form action="{{ route('updateStudentProfile') }}" method="POST">
                    @csrf
                    <div class="row mb-3">
