...
<head>
  ...
  <title>Update Request- STAGTIC </title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{route('UpdateRequest')}}" class="active">
              <i class="bi bi-circle"></i><span>Update Request</span>
            </a>
          </li>
          <li>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="{{route('UpdateRequest')}}">Update Request</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
