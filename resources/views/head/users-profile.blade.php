...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('HeadProfile')}}">
          <i class="bi bi-person "></i>
          <span>Profile</span>
        </a>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                <div class="tab-pane fade  show active profile-edit pt-3" id="profile-edit">
                  <!-- Profile Edit Form -->
                  <form action="{{ route('updateHeadProfile') }}" method="POST">
                    @csrf
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">First Name</label>
                      <div class="col-md-8 col-lg-9">
                        <input  type="text" class="form-control" id="fullName" name="first_name" value="{{ Auth::user()->first_name }}">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="company" class="col-md-4 col-lg-3 col-form-label">Last Name</label>
                      <div class="col-md-8 col-lg-9">
                        <input type="text" class="form-control" id="company" name="last_name" value="{{ Auth::user()->last_name }}">
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form action="{{ route('changeHeadPassword')}}" method="POST">
                    @csrf
                    <div class="row mb-3">
