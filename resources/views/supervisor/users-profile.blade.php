...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('SupervisorProfile')}}">
          <i class="bi bi-person "></i>
          <span>Profile</span>
        </a>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"> <a href="{{route('SupervisorProfile')}}">Profile</a> </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade  show active profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form method="POST" action="{{ route('updateSuperProfile') }}">
                    @csrf
                    <div class="row mb-3">
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form method="POST" action="{{ route('changeSuperPassword') }}">
                    @csrf
                    <div class="row mb-3">
