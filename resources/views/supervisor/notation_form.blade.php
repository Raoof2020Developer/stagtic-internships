...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('ManageTrainees')}}" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{route('ManageTrainees')}}">Note Trainee</a> </li>
          <li class="breadcrumb-item"><a href="{{route('NotationSupervisor')}}">Note Trainee</a> </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Trainne Personal Informations</h5>
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Supervisor Notation</h5>
              <p>Note:for each performance index the evaluation is between 0 and 4</p>
              <p>Excellent(4) Good(3) Medium(2) Insufficient(1) Very weak(0)</p>

              <form class="row g-3" onsubmit="calculateFinalGrade(); return false;">
                <div class="col-12">
                  <label for="inputText" class="form-label">General discipline and human relations</label>
                  <input type="text" class="form-control" id="note1" name="note1" min="0" max="4" required>
                </div>
                <div class="col-12">
                  <label for="inputText" class="form-label">work skills and handling</label>
                  <input type="text" class="form-control" id="note2" name="note2" min="0" max="4" required>
                </div>
                <div class="col-12">
                  <label for="inputText" class="form-label">initiative/entrepreneurship</label>
                  <input type="text" class="form-control" id="note3" name="note3" min="0" max="4" required>
                </div>
                <div class="col-12">
                  <label for="inputText" class="form-label">Imagination skills and innovation</label>
                  <input type="text" class="form-control" id="note4" name="note4" min="0" max="4" required>
                </div>
                <div class="col-12">
                  <label for="inputText" class="form-label">Acquired knowledge on the training ground</label>
                  <input type="text" class="form-control" id="note5" name="note5" min="0" max="4" required>
                </div>
                <div class="text-center">
                  <button type="submit" class="btn btn-primary" style="background-color: #0a52bd;">Calculate</button>
                </div>
              </form><!-- Vertical Form -->
  ...
  <script>
    function calculateFinalGrade() {
      ...
      const finalGrade = (note1 + note2 + note3 + note4 + note5);
      alert(`Note finale : ${finalGrade}`);
    }
  </script>
