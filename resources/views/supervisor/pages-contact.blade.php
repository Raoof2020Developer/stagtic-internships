...
<head>
  ...
  <title>Pages / Contact - STAGTIC </title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('SupervisorContact')}}">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="{{route('SupervisorContact')}}">Contact</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Address</h3>
                <p>University Constantine 2 Abdelhamid Mehri-New town Ali Mendjeli BP :<br>67A, Constantine-Algeria New
                  town Ali Mendjeli, 25016</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
