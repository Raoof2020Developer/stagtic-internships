    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('SupervisorRequestList')}}" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"> <a href="{{route('SupervisorRequestList')}}">Request List</a> </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                          ...
                          <table class="table datatable">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>28</td>
                                <td>2016-05-25</td>
                                <td><a href="{{route('RequestDetailsSupervisor')}}"><i class="bi bi-info-circle"></i></a></td>
